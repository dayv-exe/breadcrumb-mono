...
import { Camera, CameraDevice, CameraDeviceFormat, useCameraDevice, VideoFile } from "react-native-vision-camera";
...
export function useCamera(): useCameraReturnType {
  const { setMediaPreview, setIsRecording } = useMediaStore()
